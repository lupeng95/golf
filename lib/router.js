...
Router.onBeforeAction(verifyLoginUser,{only: ['matchperson1']});
Router.onBeforeAction(verifyLoginUser,{only: ['avatar']});
Router.onBeforeAction(verifyLoginUser,{only: ['editYourAvatarModal']});
